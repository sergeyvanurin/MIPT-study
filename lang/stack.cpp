...
/*!This func constructs stacktyp object.
@param[in] _stack - pointer on stacktyp object.
...
bool stack_construct (stacktyp* _stack, char stack_name[])
{
    ...
    memset (_stack, 0, sizeof (stacktyp));
    _stack->max_size = 1;
...
void check_size (stacktyp* _stack, int parameter)
{
...
@param[in] _stack - pointer on stacktyp object we need pop out.*/
int stack_pop (stacktyp* _stack, stack_type* pop_to)
{
...
/*!This func destructs stacktyp object.
@param[in] _stack - pointer on stacktyp object.
@param[in] stack_name - name of variable _stack.*/
int stack_destruct (stacktyp* _stack)
{
    if (stack_not_ok (_stack, DESTRUCT))
        ...
        printf ("stacktyp \"%s\" was destructed.\n", _stack->name);
...
@param[in] _stack - pointer on stacktyp object we need to check.
...
@param[in] _stack - pointer on stacktyp object we need to dump.
